...
class DataCollector:
    def __init__(self):
        ...
        self.cur_time = self.cur_time - (self.cur_time % (3600*24))  # round down to nearest day at midnight
    ...
    def get_data(self):
        ...
        while t < self.cur_time: # keep looping until we reach "now"
            ...
            # time.sleep(0.02) # go to sleep in between api calls to avoid the rate call per-minute limit
